...
// AccessPublicOperationServer is a fake server for instances of the publicoperation.AccessPublicOperationClient type.
type AccessPublicOperationServer struct {
	...
	NoDecoratorInPublic func(ctx context.Context, name string, options *publicoperation.AccessPublicOperationClientNoDecoratorInPublicOptions) (resp azfake.Responder[publicoperation.AccessPublicOperationClientNoDecoratorInPublicResponse], errResp azfake.ErrorResponder)

	// PublicDecoratorInPublic is the fake for method AccessPublicOperationClient.PublicDecoratorInPublic
	// HTTP status codes to indicate success: http.StatusOK
	PublicDecoratorInPublic func(ctx context.Context, name string, options *publicoperation.AccessPublicOperationClientPublicDecoratorInPublicOptions) (resp azfake.Responder[publicoperation.AccessPublicOperationClientPublicDecoratorInPublicResponse], errResp azfake.ErrorResponder)
}
...
// The returned AccessPublicOperationServerTransport instance is connected to an instance of publicoperation.AccessPublicOperationClient via the
...
// AccessPublicOperationServerTransport connects instances of publicoperation.AccessPublicOperationClient to instances of AccessPublicOperationServer.
