...
import (
	...
	"methodsubscriptionidgroup/twosubscriptionresourcesmethodlevel"
	"net/http"
	"net/url"
	"regexp"
	"slices"
...
// SubscriptionResource1OperationsServer is a fake server for instances of the twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClient type.
type SubscriptionResource1OperationsServer struct {
	...
	Delete func(ctx context.Context, subscriptionID string, subscriptionResource1Name string, options *twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClientDeleteOptions) (resp azfake.Responder[twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SubscriptionResource1OperationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, subscriptionID string, subscriptionResource1Name string, options *twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClientGetOptions) (resp azfake.Responder[twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClientGetResponse], errResp azfake.ErrorResponder)

	// Put is the fake for method SubscriptionResource1OperationsClient.Put
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Put func(ctx context.Context, subscriptionID string, subscriptionResource1Name string, resource twosubscriptionresourcesmethodlevel.SubscriptionResource1, options *twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClientPutOptions) (resp azfake.Responder[twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClientPutResponse], errResp azfake.ErrorResponder)
}
...
// The returned SubscriptionResource1OperationsServerTransport instance is connected to an instance of twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClient via the
...
// SubscriptionResource1OperationsServerTransport connects instances of twosubscriptionresourcesmethodlevel.SubscriptionResource1OperationsClient to instances of SubscriptionResource1OperationsServer.
...
func (s *SubscriptionResource1OperationsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Delete(req.Context(), subscriptionIDParam, subscriptionResource1NameParam, nil)
...
func (s *SubscriptionResource1OperationsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), subscriptionIDParam, subscriptionResource1NameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *SubscriptionResource1OperationsServerTransport) dispatchPut(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[twosubscriptionresourcesmethodlevel.SubscriptionResource1](req)
	if err != nil {
		return nil, err
	}
	subscriptionIDParam, err := url.PathUnescape(matches[regex.SubexpIndex("subscriptionId")])
	...
	respr, errRespr := s.srv.Put(req.Context(), subscriptionIDParam, subscriptionResource1NameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
