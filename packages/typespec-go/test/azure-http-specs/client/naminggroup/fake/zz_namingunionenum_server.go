...
// NamingUnionEnumServer is a fake server for instances of the unionenum.NamingUnionEnumClient type.
type NamingUnionEnumServer struct {
	...
	UnionEnumMemberName func(ctx context.Context, body unionenum.ExtensibleEnum, options *unionenum.NamingUnionEnumClientUnionEnumMemberNameOptions) (resp azfake.Responder[unionenum.NamingUnionEnumClientUnionEnumMemberNameResponse], errResp azfake.ErrorResponder)

	// UnionEnumName is the fake for method NamingUnionEnumClient.UnionEnumName
	// HTTP status codes to indicate success: http.StatusNoContent
	UnionEnumName func(ctx context.Context, body unionenum.ClientExtensibleEnum, options *unionenum.NamingUnionEnumClientUnionEnumNameOptions) (resp azfake.Responder[unionenum.NamingUnionEnumClientUnionEnumNameResponse], errResp azfake.ErrorResponder)
}
...
// The returned NamingUnionEnumServerTransport instance is connected to an instance of unionenum.NamingUnionEnumClient via the
...
// NamingUnionEnumServerTransport connects instances of unionenum.NamingUnionEnumClient to instances of NamingUnionEnumServer.
...
func (n *NamingUnionEnumServerTransport) dispatchUnionEnumMemberName(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[unionenum.ExtensibleEnum](req)
	if err != nil {
		return nil, err
	}
...
func (n *NamingUnionEnumServerTransport) dispatchUnionEnumName(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[unionenum.ClientExtensibleEnum](req)
	if err != nil {
		return nil, err
	}
