...
// NamingModelServer is a fake server for instances of the model.NamingModelClient type.
type NamingModelServer struct {
	// Client is the fake for method NamingModelClient.Client
	// HTTP status codes to indicate success: http.StatusNoContent
	Client func(ctx context.Context, body model.ClientModel, options *model.NamingModelClientClientOptions) (resp azfake.Responder[model.NamingModelClientClientResponse], errResp azfake.ErrorResponder)

	// Language is the fake for method NamingModelClient.Language
	// HTTP status codes to indicate success: http.StatusNoContent
	Language func(ctx context.Context, body model.GoModel, options *model.NamingModelClientLanguageOptions) (resp azfake.Responder[model.NamingModelClientLanguageResponse], errResp azfake.ErrorResponder)
}

// NewNamingModelServerTransport creates a new instance of NamingModelServerTransport with the provided implementation.
// The returned NamingModelServerTransport instance is connected to an instance of model.NamingModelClient via the
...
// NamingModelServerTransport connects instances of model.NamingModelClient to instances of NamingModelServer.
...
func (n *NamingModelServerTransport) dispatchClient(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[model.ClientModel](req)
	if err != nil {
		return nil, err
	}
...
func (n *NamingModelServerTransport) dispatchLanguage(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[model.GoModel](req)
	if err != nil {
		return nil, err
	}
