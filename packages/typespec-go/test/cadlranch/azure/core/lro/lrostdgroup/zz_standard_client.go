...
// StandardClient contains the methods for the _Specs_.Azure.Core.Lro.Standard group.
...
//     method.
func (client *StandardClient) BeginCreateOrReplace(ctx context.Context, resource User, name string, options *StandardClientCreateOrReplaceOptions) (*runtime.Poller[StandardClientCreateOrReplaceResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrReplace(ctx, resource, name, options)
		if err != nil {
			return nil, err
		}
...
func (client *StandardClient) createOrReplace(ctx context.Context, resource User, name string, options *StandardClientCreateOrReplaceOptions) (*http.Response, error) {
	var err error
	req, err := client.createOrReplaceCreateRequest(ctx, resource, name, options)
	if err != nil {
		return nil, err
	}
...
func (client *StandardClient) createOrReplaceCreateRequest(ctx context.Context, resource User, name string, options *StandardClientCreateOrReplaceOptions) (*policy.Request, error) {
