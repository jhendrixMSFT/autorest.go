...
// MediaTypeStringBodyServer is a fake server for instances of the stringbody.MediaTypeStringBodyClient type.
type MediaTypeStringBodyServer struct {
	// GetAsJSON is the fake for method MediaTypeStringBodyClient.GetAsJSON
	// HTTP status codes to indicate success: http.StatusOK
	GetAsJSON func(ctx context.Context, options *stringbody.MediaTypeStringBodyClientGetAsJSONOptions) (resp azfake.Responder[stringbody.MediaTypeStringBodyClientGetAsJSONResponse], errResp azfake.ErrorResponder)

	// GetAsText is the fake for method MediaTypeStringBodyClient.GetAsText
	// HTTP status codes to indicate success: http.StatusOK
	GetAsText func(ctx context.Context, options *stringbody.MediaTypeStringBodyClientGetAsTextOptions) (resp azfake.Responder[stringbody.MediaTypeStringBodyClientGetAsTextResponse], errResp azfake.ErrorResponder)

	// SendAsJSON is the fake for method MediaTypeStringBodyClient.SendAsJSON
	// HTTP status codes to indicate success: http.StatusOK
	SendAsJSON func(ctx context.Context, textParam string, options *stringbody.MediaTypeStringBodyClientSendAsJSONOptions) (resp azfake.Responder[stringbody.MediaTypeStringBodyClientSendAsJSONResponse], errResp azfake.ErrorResponder)

	// SendAsText is the fake for method MediaTypeStringBodyClient.SendAsText
	// HTTP status codes to indicate success: http.StatusOK
	SendAsText func(ctx context.Context, textParam string, options *stringbody.MediaTypeStringBodyClientSendAsTextOptions) (resp azfake.Responder[stringbody.MediaTypeStringBodyClientSendAsTextResponse], errResp azfake.ErrorResponder)
}
...
// The returned MediaTypeStringBodyServerTransport instance is connected to an instance of stringbody.MediaTypeStringBodyClient via the
...
// MediaTypeStringBodyServerTransport connects instances of stringbody.MediaTypeStringBodyClient to instances of MediaTypeStringBodyServer.
