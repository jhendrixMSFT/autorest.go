...
// NewPageableServerDrivenPaginationAlternateInitialVerbClient creates a new instance of [alternateinitialverb.PageableServerDrivenPaginationAlternateInitialVerbClient].
func (client *PageableServerDrivenPaginationClient) NewPageableServerDrivenPaginationAlternateInitialVerbClient() *alternateinitialverb.PageableServerDrivenPaginationAlternateInitialVerbClient {
	return &alternateinitialverb.PageableServerDrivenPaginationAlternateInitialVerbClient{
		endpoint: client.endpoint,
		internal: client.internal,
	}
}

// NewPageableServerDrivenPaginationContinuationTokenClient creates a new instance of [continuationtoken.PageableServerDrivenPaginationContinuationTokenClient].
func (client *PageableServerDrivenPaginationClient) NewPageableServerDrivenPaginationContinuationTokenClient() *continuationtoken.PageableServerDrivenPaginationContinuationTokenClient {
	return &continuationtoken.PageableServerDrivenPaginationContinuationTokenClient{
		endpoint: client.endpoint,
		internal: client.internal,
	}
}
