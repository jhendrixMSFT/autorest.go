...
// PageablePageSizeServer is a fake server for instances of the pagesize.PageablePageSizeClient type.
type PageablePageSizeServer struct {
	...
	NewListWithPageSizePager func(options *pagesize.PageablePageSizeClientListWithPageSizeOptions) (resp azfake.PagerResponder[pagesize.PageablePageSizeClientListWithPageSizeResponse])

	// NewListWithoutContinuationPager is the fake for method PageablePageSizeClient.NewListWithoutContinuationPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListWithoutContinuationPager func(options *pagesize.PageablePageSizeClientListWithoutContinuationOptions) (resp azfake.PagerResponder[pagesize.PageablePageSizeClientListWithoutContinuationResponse])
}
...
// The returned PageablePageSizeServerTransport instance is connected to an instance of pagesize.PageablePageSizeClient via the
...
func NewPageablePageSizeServerTransport(srv *PageablePageSizeServer) *PageablePageSizeServerTransport {
	return &PageablePageSizeServerTransport{
		srv:                             srv,
		newListWithPageSizePager:        newTracker[azfake.PagerResponder[pagesize.PageablePageSizeClientListWithPageSizeResponse]](),
		newListWithoutContinuationPager: newTracker[azfake.PagerResponder[pagesize.PageablePageSizeClientListWithoutContinuationResponse]](),
	}
}

// PageablePageSizeServerTransport connects instances of pagesize.PageablePageSizeClient to instances of PageablePageSizeServer.
...
type PageablePageSizeServerTransport struct {
	...
	newListWithPageSizePager        *tracker[azfake.PagerResponder[pagesize.PageablePageSizeClientListWithPageSizeResponse]]
	newListWithoutContinuationPager *tracker[azfake.PagerResponder[pagesize.PageablePageSizeClientListWithoutContinuationResponse]]
}
...
func (p *PageablePageSizeServerTransport) dispatchNewListWithPageSizePager(req *http.Request) (*http.Response, error) {
	...
	if newListWithPageSizePager == nil {
		...
		var options *pagesize.PageablePageSizeClientListWithPageSizeOptions
		if pageSizeParam != nil {
			options = &pagesize.PageablePageSizeClientListWithPageSizeOptions{
