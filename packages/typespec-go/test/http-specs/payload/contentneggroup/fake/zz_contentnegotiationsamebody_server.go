...
// ContentNegotiationSameBodyServer is a fake server for instances of the samebody.ContentNegotiationSameBodyClient type.
type ContentNegotiationSameBodyServer struct {
	...
	GetAvatarAsJPEG func(ctx context.Context, options *samebody.ContentNegotiationSameBodyClientGetAvatarAsJPEGOptions) (resp azfake.Responder[samebody.ContentNegotiationSameBodyClientGetAvatarAsJPEGResponse], errResp azfake.ErrorResponder)

	// GetAvatarAsPNG is the fake for method ContentNegotiationSameBodyClient.GetAvatarAsPNG
	// HTTP status codes to indicate success: http.StatusOK
	GetAvatarAsPNG func(ctx context.Context, options *samebody.ContentNegotiationSameBodyClientGetAvatarAsPNGOptions) (resp azfake.Responder[samebody.ContentNegotiationSameBodyClientGetAvatarAsPNGResponse], errResp azfake.ErrorResponder)
}
...
// The returned ContentNegotiationSameBodyServerTransport instance is connected to an instance of samebody.ContentNegotiationSameBodyClient via the
...
// ContentNegotiationSameBodyServerTransport connects instances of samebody.ContentNegotiationSameBodyClient to instances of ContentNegotiationSameBodyServer.
