...
// ContentNegotiationDifferentBodyServer is a fake server for instances of the differentbody.ContentNegotiationDifferentBodyClient type.
type ContentNegotiationDifferentBodyServer struct {
	...
	GetAvatarAsJSON func(ctx context.Context, options *differentbody.ContentNegotiationDifferentBodyClientGetAvatarAsJSONOptions) (resp azfake.Responder[differentbody.ContentNegotiationDifferentBodyClientGetAvatarAsJSONResponse], errResp azfake.ErrorResponder)

	// GetAvatarAsPNG is the fake for method ContentNegotiationDifferentBodyClient.GetAvatarAsPNG
	// HTTP status codes to indicate success: http.StatusOK
	GetAvatarAsPNG func(ctx context.Context, options *differentbody.ContentNegotiationDifferentBodyClientGetAvatarAsPNGOptions) (resp azfake.Responder[differentbody.ContentNegotiationDifferentBodyClientGetAvatarAsPNGResponse], errResp azfake.ErrorResponder)
}
...
// The returned ContentNegotiationDifferentBodyServerTransport instance is connected to an instance of differentbody.ContentNegotiationDifferentBodyClient via the
...
// ContentNegotiationDifferentBodyServerTransport connects instances of differentbody.ContentNegotiationDifferentBodyClient to instances of ContentNegotiationDifferentBodyServer.
