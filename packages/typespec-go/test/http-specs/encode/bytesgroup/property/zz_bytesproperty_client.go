...
func (client *BytesPropertyClient) Base64(ctx context.Context, body bytesgroup.Base64BytesProperty, options *BytesPropertyClientBase64Options) (BytesPropertyClientBase64Response, error) {
	var err error
...
func (client *BytesPropertyClient) base64CreateRequest(ctx context.Context, body bytesgroup.Base64BytesProperty, _ *BytesPropertyClientBase64Options) (*policy.Request, error) {
...
func (client *BytesPropertyClient) Base64URL(ctx context.Context, body bytesgroup.Base64URLBytesProperty, options *BytesPropertyClientBase64URLOptions) (BytesPropertyClientBase64URLResponse, error) {
	var err error
...
func (client *BytesPropertyClient) base64URLCreateRequest(ctx context.Context, body bytesgroup.Base64URLBytesProperty, _ *BytesPropertyClientBase64URLOptions) (*policy.Request, error) {
...
//     method.
func (client *BytesPropertyClient) Base64URLArray(ctx context.Context, body bytesgroup.Base64URLArrayBytesProperty, options *BytesPropertyClientBase64URLArrayOptions) (BytesPropertyClientBase64URLArrayResponse, error) {
	var err error
...
func (client *BytesPropertyClient) base64URLArrayCreateRequest(ctx context.Context, body bytesgroup.Base64URLArrayBytesProperty, _ *BytesPropertyClientBase64URLArrayOptions) (*policy.Request, error) {
...
func (client *BytesPropertyClient) Default(ctx context.Context, body bytesgroup.DefaultBytesProperty, options *BytesPropertyClientDefaultOptions) (BytesPropertyClientDefaultResponse, error) {
	var err error
...
func (client *BytesPropertyClient) defaultCreateRequest(ctx context.Context, body bytesgroup.DefaultBytesProperty, _ *BytesPropertyClientDefaultOptions) (*policy.Request, error) {
