...
// BytesPropertyServer is a fake server for instances of the property.BytesPropertyClient type.
type BytesPropertyServer struct {
	// Base64 is the fake for method BytesPropertyClient.Base64
	// HTTP status codes to indicate success: http.StatusOK
	Base64 func(ctx context.Context, body bytesgroup.Base64BytesProperty, options *property.BytesPropertyClientBase64Options) (resp azfake.Responder[property.BytesPropertyClientBase64Response], errResp azfake.ErrorResponder)

	// Base64URL is the fake for method BytesPropertyClient.Base64URL
	// HTTP status codes to indicate success: http.StatusOK
	Base64URL func(ctx context.Context, body bytesgroup.Base64URLBytesProperty, options *property.BytesPropertyClientBase64URLOptions) (resp azfake.Responder[property.BytesPropertyClientBase64URLResponse], errResp azfake.ErrorResponder)

	// Base64URLArray is the fake for method BytesPropertyClient.Base64URLArray
	// HTTP status codes to indicate success: http.StatusOK
	Base64URLArray func(ctx context.Context, body bytesgroup.Base64URLArrayBytesProperty, options *property.BytesPropertyClientBase64URLArrayOptions) (resp azfake.Responder[property.BytesPropertyClientBase64URLArrayResponse], errResp azfake.ErrorResponder)

	// Default is the fake for method BytesPropertyClient.Default
	// HTTP status codes to indicate success: http.StatusOK
	Default func(ctx context.Context, body bytesgroup.DefaultBytesProperty, options *property.BytesPropertyClientDefaultOptions) (resp azfake.Responder[property.BytesPropertyClientDefaultResponse], errResp azfake.ErrorResponder)
}

// NewBytesPropertyServerTransport creates a new instance of BytesPropertyServerTransport with the provided implementation.
// The returned BytesPropertyServerTransport instance is connected to an instance of property.BytesPropertyClient via the
...
// BytesPropertyServerTransport connects instances of property.BytesPropertyClient to instances of BytesPropertyServer.
