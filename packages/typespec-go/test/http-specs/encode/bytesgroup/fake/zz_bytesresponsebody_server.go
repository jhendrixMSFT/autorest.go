...
// BytesResponseBodyServer is a fake server for instances of the responsebody.BytesResponseBodyClient type.
type BytesResponseBodyServer struct {
	// Base64 is the fake for method BytesResponseBodyClient.Base64
	// HTTP status codes to indicate success: http.StatusOK
	Base64 func(ctx context.Context, options *responsebody.BytesResponseBodyClientBase64Options) (resp azfake.Responder[responsebody.BytesResponseBodyClientBase64Response], errResp azfake.ErrorResponder)

	// Base64URL is the fake for method BytesResponseBodyClient.Base64URL
	// HTTP status codes to indicate success: http.StatusOK
	Base64URL func(ctx context.Context, options *responsebody.BytesResponseBodyClientBase64URLOptions) (resp azfake.Responder[responsebody.BytesResponseBodyClientBase64URLResponse], errResp azfake.ErrorResponder)

	// CustomContentType is the fake for method BytesResponseBodyClient.CustomContentType
	// HTTP status codes to indicate success: http.StatusOK
	CustomContentType func(ctx context.Context, options *responsebody.BytesResponseBodyClientCustomContentTypeOptions) (resp azfake.Responder[responsebody.BytesResponseBodyClientCustomContentTypeResponse], errResp azfake.ErrorResponder)

	// Default is the fake for method BytesResponseBodyClient.Default
	// HTTP status codes to indicate success: http.StatusOK
	Default func(ctx context.Context, options *responsebody.BytesResponseBodyClientDefaultOptions) (resp azfake.Responder[responsebody.BytesResponseBodyClientDefaultResponse], errResp azfake.ErrorResponder)

	// OctetStream is the fake for method BytesResponseBodyClient.OctetStream
	// HTTP status codes to indicate success: http.StatusOK
	OctetStream func(ctx context.Context, options *responsebody.BytesResponseBodyClientOctetStreamOptions) (resp azfake.Responder[responsebody.BytesResponseBodyClientOctetStreamResponse], errResp azfake.ErrorResponder)
}
...
// The returned BytesResponseBodyServerTransport instance is connected to an instance of responsebody.BytesResponseBodyClient via the
...
// BytesResponseBodyServerTransport connects instances of responsebody.BytesResponseBodyClient to instances of BytesResponseBodyServer.
