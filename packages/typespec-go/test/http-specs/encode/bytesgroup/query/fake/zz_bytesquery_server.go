...
// BytesQueryServer is a fake server for instances of the query.BytesQueryClient type.
type BytesQueryServer struct {
	// Base64 is the fake for method BytesQueryClient.Base64
	// HTTP status codes to indicate success: http.StatusNoContent
	Base64 func(ctx context.Context, value []byte, options *query.BytesQueryClientBase64Options) (resp azfake.Responder[query.BytesQueryClientBase64Response], errResp azfake.ErrorResponder)

	// Base64URL is the fake for method BytesQueryClient.Base64URL
	// HTTP status codes to indicate success: http.StatusNoContent
	Base64URL func(ctx context.Context, value []byte, options *query.BytesQueryClientBase64URLOptions) (resp azfake.Responder[query.BytesQueryClientBase64URLResponse], errResp azfake.ErrorResponder)

	// Base64URLArray is the fake for method BytesQueryClient.Base64URLArray
	// HTTP status codes to indicate success: http.StatusNoContent
	Base64URLArray func(ctx context.Context, value [][]byte, options *query.BytesQueryClientBase64URLArrayOptions) (resp azfake.Responder[query.BytesQueryClientBase64URLArrayResponse], errResp azfake.ErrorResponder)

	// Default is the fake for method BytesQueryClient.Default
	// HTTP status codes to indicate success: http.StatusNoContent
	Default func(ctx context.Context, value []byte, options *query.BytesQueryClientDefaultOptions) (resp azfake.Responder[query.BytesQueryClientDefaultResponse], errResp azfake.ErrorResponder)
}

// NewBytesQueryServerTransport creates a new instance of BytesQueryServerTransport with the provided implementation.
// The returned BytesQueryServerTransport instance is connected to an instance of query.BytesQueryClient via the
...
// BytesQueryServerTransport connects instances of query.BytesQueryClient to instances of BytesQueryServer.
...
func (b *BytesQueryServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if bytesQueryServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = bytesQueryServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (b *BytesQueryServerTransport) dispatchBase64(req *http.Request) (*http.Response, error) {
	...
	qp := req.URL.Query()
	valueParam, err := base64.StdEncoding.DecodeString(qp.Get("value"))
	if err != nil {
		return nil, err
	}
...
func (b *BytesQueryServerTransport) dispatchBase64URL(req *http.Request) (*http.Response, error) {
	...
	qp := req.URL.Query()
	valueParam, err := base64.URLEncoding.DecodeString(qp.Get("value"))
	if err != nil {
		return nil, err
	}
...
// set this to conditionally intercept incoming requests to BytesQueryServerTransport
var bytesQueryServerTransportInterceptor interface {
