...
// DatetimePropertyServer is a fake server for instances of the property.DatetimePropertyClient type.
type DatetimePropertyServer struct {
	// Default is the fake for method DatetimePropertyClient.Default
	// HTTP status codes to indicate success: http.StatusOK
	Default func(ctx context.Context, body datetimegroup.DefaultDatetimeProperty, options *property.DatetimePropertyClientDefaultOptions) (resp azfake.Responder[property.DatetimePropertyClientDefaultResponse], errResp azfake.ErrorResponder)

	// RFC3339 is the fake for method DatetimePropertyClient.RFC3339
	// HTTP status codes to indicate success: http.StatusOK
	RFC3339 func(ctx context.Context, body datetimegroup.RFC3339DatetimeProperty, options *property.DatetimePropertyClientRFC3339Options) (resp azfake.Responder[property.DatetimePropertyClientRFC3339Response], errResp azfake.ErrorResponder)

	// RFC7231 is the fake for method DatetimePropertyClient.RFC7231
	// HTTP status codes to indicate success: http.StatusOK
	RFC7231 func(ctx context.Context, body datetimegroup.RFC7231DatetimeProperty, options *property.DatetimePropertyClientRFC7231Options) (resp azfake.Responder[property.DatetimePropertyClientRFC7231Response], errResp azfake.ErrorResponder)

	// UnixTimestamp is the fake for method DatetimePropertyClient.UnixTimestamp
	// HTTP status codes to indicate success: http.StatusOK
	UnixTimestamp func(ctx context.Context, body datetimegroup.UnixTimestampDatetimeProperty, options *property.DatetimePropertyClientUnixTimestampOptions) (resp azfake.Responder[property.DatetimePropertyClientUnixTimestampResponse], errResp azfake.ErrorResponder)

	// UnixTimestampArray is the fake for method DatetimePropertyClient.UnixTimestampArray
	// HTTP status codes to indicate success: http.StatusOK
	UnixTimestampArray func(ctx context.Context, body datetimegroup.UnixTimestampArrayDatetimeProperty, options *property.DatetimePropertyClientUnixTimestampArrayOptions) (resp azfake.Responder[property.DatetimePropertyClientUnixTimestampArrayResponse], errResp azfake.ErrorResponder)
}
...
// The returned DatetimePropertyServerTransport instance is connected to an instance of property.DatetimePropertyClient via the
...
// DatetimePropertyServerTransport connects instances of property.DatetimePropertyClient to instances of DatetimePropertyServer.
