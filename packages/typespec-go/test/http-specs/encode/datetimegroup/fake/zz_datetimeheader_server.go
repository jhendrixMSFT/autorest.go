...
// DatetimeHeaderServer is a fake server for instances of the header.DatetimeHeaderClient type.
type DatetimeHeaderServer struct {
	// Default is the fake for method DatetimeHeaderClient.Default
	// HTTP status codes to indicate success: http.StatusNoContent
	Default func(ctx context.Context, value time.Time, options *header.DatetimeHeaderClientDefaultOptions) (resp azfake.Responder[header.DatetimeHeaderClientDefaultResponse], errResp azfake.ErrorResponder)

	// RFC3339 is the fake for method DatetimeHeaderClient.RFC3339
	// HTTP status codes to indicate success: http.StatusNoContent
	RFC3339 func(ctx context.Context, value time.Time, options *header.DatetimeHeaderClientRFC3339Options) (resp azfake.Responder[header.DatetimeHeaderClientRFC3339Response], errResp azfake.ErrorResponder)

	// RFC7231 is the fake for method DatetimeHeaderClient.RFC7231
	// HTTP status codes to indicate success: http.StatusNoContent
	RFC7231 func(ctx context.Context, value time.Time, options *header.DatetimeHeaderClientRFC7231Options) (resp azfake.Responder[header.DatetimeHeaderClientRFC7231Response], errResp azfake.ErrorResponder)

	// UnixTimestamp is the fake for method DatetimeHeaderClient.UnixTimestamp
	// HTTP status codes to indicate success: http.StatusNoContent
	UnixTimestamp func(ctx context.Context, value time.Time, options *header.DatetimeHeaderClientUnixTimestampOptions) (resp azfake.Responder[header.DatetimeHeaderClientUnixTimestampResponse], errResp azfake.ErrorResponder)

	// UnixTimestampArray is the fake for method DatetimeHeaderClient.UnixTimestampArray
	// HTTP status codes to indicate success: http.StatusNoContent
	UnixTimestampArray func(ctx context.Context, value []time.Time, options *header.DatetimeHeaderClientUnixTimestampArrayOptions) (resp azfake.Responder[header.DatetimeHeaderClientUnixTimestampArrayResponse], errResp azfake.ErrorResponder)
}
...
// The returned DatetimeHeaderServerTransport instance is connected to an instance of header.DatetimeHeaderClient via the
...
// DatetimeHeaderServerTransport connects instances of header.DatetimeHeaderClient to instances of DatetimeHeaderServer.
