...
// DatetimeResponseHeaderServer is a fake server for instances of the responseheader.DatetimeResponseHeaderClient type.
type DatetimeResponseHeaderServer struct {
	// Default is the fake for method DatetimeResponseHeaderClient.Default
	// HTTP status codes to indicate success: http.StatusNoContent
	Default func(ctx context.Context, options *responseheader.DatetimeResponseHeaderClientDefaultOptions) (resp azfake.Responder[responseheader.DatetimeResponseHeaderClientDefaultResponse], errResp azfake.ErrorResponder)

	// RFC3339 is the fake for method DatetimeResponseHeaderClient.RFC3339
	// HTTP status codes to indicate success: http.StatusNoContent
	RFC3339 func(ctx context.Context, options *responseheader.DatetimeResponseHeaderClientRFC3339Options) (resp azfake.Responder[responseheader.DatetimeResponseHeaderClientRFC3339Response], errResp azfake.ErrorResponder)

	// RFC7231 is the fake for method DatetimeResponseHeaderClient.RFC7231
	// HTTP status codes to indicate success: http.StatusNoContent
	RFC7231 func(ctx context.Context, options *responseheader.DatetimeResponseHeaderClientRFC7231Options) (resp azfake.Responder[responseheader.DatetimeResponseHeaderClientRFC7231Response], errResp azfake.ErrorResponder)

	// UnixTimestamp is the fake for method DatetimeResponseHeaderClient.UnixTimestamp
	// HTTP status codes to indicate success: http.StatusNoContent
	UnixTimestamp func(ctx context.Context, options *responseheader.DatetimeResponseHeaderClientUnixTimestampOptions) (resp azfake.Responder[responseheader.DatetimeResponseHeaderClientUnixTimestampResponse], errResp azfake.ErrorResponder)
}
...
// The returned DatetimeResponseHeaderServerTransport instance is connected to an instance of responseheader.DatetimeResponseHeaderClient via the
...
// DatetimeResponseHeaderServerTransport connects instances of responseheader.DatetimeResponseHeaderClient to instances of DatetimeResponseHeaderServer.
