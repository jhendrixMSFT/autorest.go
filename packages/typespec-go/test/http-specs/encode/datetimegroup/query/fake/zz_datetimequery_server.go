...
// DatetimeQueryServer is a fake server for instances of the query.DatetimeQueryClient type.
type DatetimeQueryServer struct {
	// Default is the fake for method DatetimeQueryClient.Default
	// HTTP status codes to indicate success: http.StatusNoContent
	Default func(ctx context.Context, value time.Time, options *query.DatetimeQueryClientDefaultOptions) (resp azfake.Responder[query.DatetimeQueryClientDefaultResponse], errResp azfake.ErrorResponder)

	// RFC3339 is the fake for method DatetimeQueryClient.RFC3339
	// HTTP status codes to indicate success: http.StatusNoContent
	RFC3339 func(ctx context.Context, value time.Time, options *query.DatetimeQueryClientRFC3339Options) (resp azfake.Responder[query.DatetimeQueryClientRFC3339Response], errResp azfake.ErrorResponder)

	// RFC7231 is the fake for method DatetimeQueryClient.RFC7231
	// HTTP status codes to indicate success: http.StatusNoContent
	RFC7231 func(ctx context.Context, value time.Time, options *query.DatetimeQueryClientRFC7231Options) (resp azfake.Responder[query.DatetimeQueryClientRFC7231Response], errResp azfake.ErrorResponder)

	// UnixTimestamp is the fake for method DatetimeQueryClient.UnixTimestamp
	// HTTP status codes to indicate success: http.StatusNoContent
	UnixTimestamp func(ctx context.Context, value time.Time, options *query.DatetimeQueryClientUnixTimestampOptions) (resp azfake.Responder[query.DatetimeQueryClientUnixTimestampResponse], errResp azfake.ErrorResponder)

	// UnixTimestampArray is the fake for method DatetimeQueryClient.UnixTimestampArray
	// HTTP status codes to indicate success: http.StatusNoContent
	UnixTimestampArray func(ctx context.Context, value []time.Time, options *query.DatetimeQueryClientUnixTimestampArrayOptions) (resp azfake.Responder[query.DatetimeQueryClientUnixTimestampArrayResponse], errResp azfake.ErrorResponder)
}

// NewDatetimeQueryServerTransport creates a new instance of DatetimeQueryServerTransport with the provided implementation.
// The returned DatetimeQueryServerTransport instance is connected to an instance of query.DatetimeQueryClient via the
...
// DatetimeQueryServerTransport connects instances of query.DatetimeQueryClient to instances of DatetimeQueryServer.
