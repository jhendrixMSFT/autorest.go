...
// NumericPropertyServer is a fake server for instances of the property.NumericPropertyClient type.
type NumericPropertyServer struct {
	// SafeintAsString is the fake for method NumericPropertyClient.SafeintAsString
	// HTTP status codes to indicate success: http.StatusOK
	SafeintAsString func(ctx context.Context, value property.SafeintAsStringProperty, options *property.NumericPropertyClientSafeintAsStringOptions) (resp azfake.Responder[property.NumericPropertyClientSafeintAsStringResponse], errResp azfake.ErrorResponder)

	// Uint32AsStringOptional is the fake for method NumericPropertyClient.Uint32AsStringOptional
	// HTTP status codes to indicate success: http.StatusOK
	Uint32AsStringOptional func(ctx context.Context, value property.Uint32AsStringProperty, options *property.NumericPropertyClientUint32AsStringOptionalOptions) (resp azfake.Responder[property.NumericPropertyClientUint32AsStringOptionalResponse], errResp azfake.ErrorResponder)

	// Uint8AsString is the fake for method NumericPropertyClient.Uint8AsString
	// HTTP status codes to indicate success: http.StatusOK
	Uint8AsString func(ctx context.Context, value property.Uint8AsStringProperty, options *property.NumericPropertyClientUint8AsStringOptions) (resp azfake.Responder[property.NumericPropertyClientUint8AsStringResponse], errResp azfake.ErrorResponder)
}
...
// The returned NumericPropertyServerTransport instance is connected to an instance of property.NumericPropertyClient via the
...
// NumericPropertyServerTransport connects instances of property.NumericPropertyClient to instances of NumericPropertyServer.
...
func (n *NumericPropertyServerTransport) dispatchSafeintAsString(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[property.SafeintAsStringProperty](req)
	if err != nil {
		return nil, err
	}
...
func (n *NumericPropertyServerTransport) dispatchUint32AsStringOptional(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[property.Uint32AsStringProperty](req)
	if err != nil {
		return nil, err
	}
...
func (n *NumericPropertyServerTransport) dispatchUint8AsString(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[property.Uint8AsStringProperty](req)
	if err != nil {
		return nil, err
	}
