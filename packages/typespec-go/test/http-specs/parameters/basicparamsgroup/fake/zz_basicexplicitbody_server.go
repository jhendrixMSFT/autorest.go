...
// BasicExplicitBodyServer is a fake server for instances of the explicitbody.BasicExplicitBodyClient type.
type BasicExplicitBodyServer struct {
	// Simple is the fake for method BasicExplicitBodyClient.Simple
	// HTTP status codes to indicate success: http.StatusNoContent
	Simple func(ctx context.Context, body explicitbody.User, options *explicitbody.BasicExplicitBodyClientSimpleOptions) (resp azfake.Responder[explicitbody.BasicExplicitBodyClientSimpleResponse], errResp azfake.ErrorResponder)
}
...
// The returned BasicExplicitBodyServerTransport instance is connected to an instance of explicitbody.BasicExplicitBodyClient via the
...
// BasicExplicitBodyServerTransport connects instances of explicitbody.BasicExplicitBodyClient to instances of BasicExplicitBodyServer.
...
func (b *BasicExplicitBodyServerTransport) dispatchSimple(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[explicitbody.User](req)
	if err != nil {
		return nil, err
	}
