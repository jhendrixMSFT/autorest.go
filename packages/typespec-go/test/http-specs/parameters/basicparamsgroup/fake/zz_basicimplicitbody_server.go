...
// BasicImplicitBodyServer is a fake server for instances of the implicitbody.BasicImplicitBodyClient type.
type BasicImplicitBodyServer struct {
	// Simple is the fake for method BasicImplicitBodyClient.Simple
	// HTTP status codes to indicate success: http.StatusNoContent
	Simple func(ctx context.Context, name string, options *implicitbody.BasicImplicitBodyClientSimpleOptions) (resp azfake.Responder[implicitbody.BasicImplicitBodyClientSimpleResponse], errResp azfake.ErrorResponder)
}
...
// The returned BasicImplicitBodyServerTransport instance is connected to an instance of implicitbody.BasicImplicitBodyClient via the
...
// BasicImplicitBodyServerTransport connects instances of implicitbody.BasicImplicitBodyClient to instances of BasicImplicitBodyServer.
