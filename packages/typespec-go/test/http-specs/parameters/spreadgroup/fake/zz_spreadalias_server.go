...
// SpreadAliasServer is a fake server for instances of the alias.SpreadAliasClient type.
type SpreadAliasServer struct {
	// SpreadAsRequestBody is the fake for method SpreadAliasClient.SpreadAsRequestBody
	// HTTP status codes to indicate success: http.StatusNoContent
	SpreadAsRequestBody func(ctx context.Context, name string, options *alias.SpreadAliasClientSpreadAsRequestBodyOptions) (resp azfake.Responder[alias.SpreadAliasClientSpreadAsRequestBodyResponse], errResp azfake.ErrorResponder)

	// SpreadAsRequestParameter is the fake for method SpreadAliasClient.SpreadAsRequestParameter
	// HTTP status codes to indicate success: http.StatusNoContent
	SpreadAsRequestParameter func(ctx context.Context, id string, xMSTestHeader string, name string, options *alias.SpreadAliasClientSpreadAsRequestParameterOptions) (resp azfake.Responder[alias.SpreadAliasClientSpreadAsRequestParameterResponse], errResp azfake.ErrorResponder)

	// SpreadParameterWithInnerAlias is the fake for method SpreadAliasClient.SpreadParameterWithInnerAlias
	// HTTP status codes to indicate success: http.StatusNoContent
	SpreadParameterWithInnerAlias func(ctx context.Context, id string, name string, age int32, xMSTestHeader string, options *alias.SpreadAliasClientSpreadParameterWithInnerAliasOptions) (resp azfake.Responder[alias.SpreadAliasClientSpreadParameterWithInnerAliasResponse], errResp azfake.ErrorResponder)

	// SpreadParameterWithInnerModel is the fake for method SpreadAliasClient.SpreadParameterWithInnerModel
	// HTTP status codes to indicate success: http.StatusNoContent
	SpreadParameterWithInnerModel func(ctx context.Context, id string, name string, xMSTestHeader string, options *alias.SpreadAliasClientSpreadParameterWithInnerModelOptions) (resp azfake.Responder[alias.SpreadAliasClientSpreadParameterWithInnerModelResponse], errResp azfake.ErrorResponder)

	// SpreadWithMultipleParameters is the fake for method SpreadAliasClient.SpreadWithMultipleParameters
	// HTTP status codes to indicate success: http.StatusNoContent
	SpreadWithMultipleParameters func(ctx context.Context, id string, xMSTestHeader string, requiredString string, requiredIntList []int32, options *alias.SpreadAliasClientSpreadWithMultipleParametersOptions) (resp azfake.Responder[alias.SpreadAliasClientSpreadWithMultipleParametersResponse], errResp azfake.ErrorResponder)
}

// NewSpreadAliasServerTransport creates a new instance of SpreadAliasServerTransport with the provided implementation.
// The returned SpreadAliasServerTransport instance is connected to an instance of alias.SpreadAliasClient via the
...
// SpreadAliasServerTransport connects instances of alias.SpreadAliasClient to instances of SpreadAliasServer.
...
func (s *SpreadAliasServerTransport) dispatchSpreadWithMultipleParameters(req *http.Request) (*http.Response, error) {
	...
	var options *alias.SpreadAliasClientSpreadWithMultipleParametersOptions
	if body.OptionalInt != nil || len(body.OptionalStringList) > 0 {
		options = &alias.SpreadAliasClientSpreadWithMultipleParametersOptions{
