...
// CollectionFormatHeaderServer is a fake server for instances of the header.CollectionFormatHeaderClient type.
type CollectionFormatHeaderServer struct {
	// CSV is the fake for method CollectionFormatHeaderClient.CSV
	// HTTP status codes to indicate success: http.StatusNoContent
	CSV func(ctx context.Context, colors []string, options *header.CollectionFormatHeaderClientCSVOptions) (resp azfake.Responder[header.CollectionFormatHeaderClientCSVResponse], errResp azfake.ErrorResponder)
}
...
// The returned CollectionFormatHeaderServerTransport instance is connected to an instance of header.CollectionFormatHeaderClient via the
...
// CollectionFormatHeaderServerTransport connects instances of header.CollectionFormatHeaderClient to instances of CollectionFormatHeaderServer.
