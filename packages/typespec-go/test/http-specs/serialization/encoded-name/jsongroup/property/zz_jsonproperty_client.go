...
type JSONPropertyClient base.Client

// internals returns the shared base client state.
func (client *JSONPropertyClient) internals() *base.Client {
...
func (client *JSONPropertyClient) sendCreateRequest(ctx context.Context, body JSONEncodedNameModel, _ *JSONPropertyClientSendOptions) (*policy.Request, error) {
	urlPath := "/serialization/encoded-name/json/property"
	req, err := runtime.NewRequest(ctx, http.MethodPost, runtime.JoinPaths(client.internals().Endpoint(), urlPath))
	if err != nil {
		return nil, err
	}
