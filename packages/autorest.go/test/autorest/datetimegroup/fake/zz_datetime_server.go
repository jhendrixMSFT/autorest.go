...
func (d *DatetimeServerTransport) dispatchGetInvalid(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, datetime.New(datetime.FormatRFC3339, &datetime.Options{From: fromPtr(server.GetResponse(respr).Value)}), req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (d *DatetimeServerTransport) dispatchPutLocalNegativeOffsetMaxDateTime(req *http.Request) (*http.Response, error) {
	...
	body, err := unmarshalTimeAsJSON(req, datetime.FormatRFC3339)
	if err != nil {
		return nil, err
	}
	respr, errRespr := d.srv.PutLocalNegativeOffsetMaxDateTime(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DatetimeServerTransport) dispatchPutLocalNegativeOffsetMinDateTime(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.PutLocalNegativeOffsetMinDateTime(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DatetimeServerTransport) dispatchPutLocalPositiveOffsetMaxDateTime(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.PutLocalPositiveOffsetMaxDateTime(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DatetimeServerTransport) dispatchPutLocalPositiveOffsetMinDateTime(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.PutLocalPositiveOffsetMinDateTime(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DatetimeServerTransport) dispatchPutUTCMaxDateTime(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.PutUTCMaxDateTime(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DatetimeServerTransport) dispatchPutUTCMaxDateTime7Digits(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.PutUTCMaxDateTime7Digits(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DatetimeServerTransport) dispatchPutUTCMinDateTime(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.PutUTCMinDateTime(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
