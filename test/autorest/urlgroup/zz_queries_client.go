...
//     method.
func (client *QueriesClient) ArrayStringCSVEmpty(ctx context.Context, options *QueriesClientArrayStringCSVEmptyOptions) (result QueriesClientArrayStringCSVEmptyResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringCSVEmpty", &tracing.SpanOptions{
...
//     method.
func (client *QueriesClient) ArrayStringCSVNull(ctx context.Context, options *QueriesClientArrayStringCSVNullOptions) (result QueriesClientArrayStringCSVNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringCSVNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) ArrayStringCSVValid(ctx context.Context, options *QueriesClientArrayStringCSVValidOptions) (result QueriesClientArrayStringCSVValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringCSVValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) ArrayStringNoCollectionFormatEmpty(ctx context.Context, options *QueriesClientArrayStringNoCollectionFormatEmptyOptions) (result QueriesClientArrayStringNoCollectionFormatEmptyResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringNoCollectionFormatEmpty", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) ArrayStringPipesValid(ctx context.Context, options *QueriesClientArrayStringPipesValidOptions) (result QueriesClientArrayStringPipesValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringPipesValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) ArrayStringSsvValid(ctx context.Context, options *QueriesClientArrayStringSsvValidOptions) (result QueriesClientArrayStringSsvValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringSsvValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) ArrayStringTsvValid(ctx context.Context, options *QueriesClientArrayStringTsvValidOptions) (result QueriesClientArrayStringTsvValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ArrayStringTsvValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) ByteEmpty(ctx context.Context, options *QueriesClientByteEmptyOptions) (result QueriesClientByteEmptyResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ByteEmpty", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) ByteMultiByte(ctx context.Context, options *QueriesClientByteMultiByteOptions) (result QueriesClientByteMultiByteResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ByteMultiByte", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) ByteNull(ctx context.Context, options *QueriesClientByteNullOptions) (result QueriesClientByteNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.ByteNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) DateNull(ctx context.Context, options *QueriesClientDateNullOptions) (result QueriesClientDateNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DateNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) DateTimeNull(ctx context.Context, options *QueriesClientDateTimeNullOptions) (result QueriesClientDateTimeNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DateTimeNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) DateTimeValid(ctx context.Context, options *QueriesClientDateTimeValidOptions) (result QueriesClientDateTimeValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DateTimeValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) DateValid(ctx context.Context, options *QueriesClientDateValidOptions) (result QueriesClientDateValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DateValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) DoubleDecimalNegative(ctx context.Context, options *QueriesClientDoubleDecimalNegativeOptions) (result QueriesClientDoubleDecimalNegativeResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DoubleDecimalNegative", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) DoubleDecimalPositive(ctx context.Context, options *QueriesClientDoubleDecimalPositiveOptions) (result QueriesClientDoubleDecimalPositiveResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DoubleDecimalPositive", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) DoubleNull(ctx context.Context, options *QueriesClientDoubleNullOptions) (result QueriesClientDoubleNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.DoubleNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) EnumNull(ctx context.Context, options *QueriesClientEnumNullOptions) (result QueriesClientEnumNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.EnumNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) EnumValid(ctx context.Context, options *QueriesClientEnumValidOptions) (result QueriesClientEnumValidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.EnumValid", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) FloatNull(ctx context.Context, options *QueriesClientFloatNullOptions) (result QueriesClientFloatNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.FloatNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) FloatScientificNegative(ctx context.Context, options *QueriesClientFloatScientificNegativeOptions) (result QueriesClientFloatScientificNegativeResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.FloatScientificNegative", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) FloatScientificPositive(ctx context.Context, options *QueriesClientFloatScientificPositiveOptions) (result QueriesClientFloatScientificPositiveResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.FloatScientificPositive", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) GetBooleanFalse(ctx context.Context, options *QueriesClientGetBooleanFalseOptions) (result QueriesClientGetBooleanFalseResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetBooleanFalse", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) GetBooleanNull(ctx context.Context, options *QueriesClientGetBooleanNullOptions) (result QueriesClientGetBooleanNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetBooleanNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) GetBooleanTrue(ctx context.Context, options *QueriesClientGetBooleanTrueOptions) (result QueriesClientGetBooleanTrueResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetBooleanTrue", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) GetIntNegativeOneMillion(ctx context.Context, options *QueriesClientGetIntNegativeOneMillionOptions) (result QueriesClientGetIntNegativeOneMillionResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetIntNegativeOneMillion", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) GetIntNull(ctx context.Context, options *QueriesClientGetIntNullOptions) (result QueriesClientGetIntNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetIntNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) GetIntOneMillion(ctx context.Context, options *QueriesClientGetIntOneMillionOptions) (result QueriesClientGetIntOneMillionResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetIntOneMillion", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) GetLongNull(ctx context.Context, options *QueriesClientGetLongNullOptions) (result QueriesClientGetLongNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetLongNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) GetNegativeTenBillion(ctx context.Context, options *QueriesClientGetNegativeTenBillionOptions) (result QueriesClientGetNegativeTenBillionResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetNegativeTenBillion", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) GetTenBillion(ctx context.Context, options *QueriesClientGetTenBillionOptions) (result QueriesClientGetTenBillionResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.GetTenBillion", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) StringEmpty(ctx context.Context, options *QueriesClientStringEmptyOptions) (result QueriesClientStringEmptyResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.StringEmpty", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) StringNull(ctx context.Context, options *QueriesClientStringNullOptions) (result QueriesClientStringNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.StringNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
//     method.
func (client *QueriesClient) StringURLEncoded(ctx context.Context, options *QueriesClientStringURLEncodedOptions) (result QueriesClientStringURLEncodedResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.StringURLEncoded", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *QueriesClient) StringUnicode(ctx context.Context, options *QueriesClientStringUnicodeOptions) (result QueriesClientStringUnicodeResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "QueriesClient.StringUnicode", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
