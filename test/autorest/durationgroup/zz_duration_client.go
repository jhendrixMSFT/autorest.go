...
func (client *DurationClient) GetInvalid(ctx context.Context, options *DurationClientGetInvalidOptions) (result DurationClientGetInvalidResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "DurationClient.GetInvalid", &tracing.SpanOptions{
...
func (client *DurationClient) getInvalidHandleResponse(resp *http.Response) (result DurationClientGetInvalidResponse, err error) {
...
func (client *DurationClient) GetNull(ctx context.Context, options *DurationClientGetNullOptions) (result DurationClientGetNullResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "DurationClient.GetNull", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *DurationClient) getNullHandleResponse(resp *http.Response) (result DurationClientGetNullResponse, err error) {
	if err = runtime.UnmarshalAsJSON(resp, &result.Value); err != nil {
...
//     method.
func (client *DurationClient) GetPositiveDuration(ctx context.Context, options *DurationClientGetPositiveDurationOptions) (result DurationClientGetPositiveDurationResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "DurationClient.GetPositiveDuration", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
...
func (client *DurationClient) getPositiveDurationHandleResponse(resp *http.Response) (result DurationClientGetPositiveDurationResponse, err error) {
	if err = runtime.UnmarshalAsJSON(resp, &result.Value); err != nil {
...
//     method.
func (client *DurationClient) PutPositiveDuration(ctx context.Context, durationBody string, options *DurationClientPutPositiveDurationOptions) (result DurationClientPutPositiveDurationResponse, err error) {
	ctx, span := client.internal.Tracer().Start(ctx, "DurationClient.PutPositiveDuration", &tracing.SpanOptions{
		Kind: tracing.SpanKindInternal,
	})
	defer func() {
		if err != nil {
