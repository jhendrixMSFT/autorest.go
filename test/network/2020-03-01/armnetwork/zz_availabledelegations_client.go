...
func (client *AvailableDelegationsClient) NewListPager(location string, options *AvailableDelegationsClientListOptions) *runtime.Pager[AvailableDelegationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[AvailableDelegationsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *AvailableDelegationsClientListResponse) (result AvailableDelegationsClientListResponse, err error) {
			ctx, span := client.internal.Tracer().Start(ctx, "AvailableDelegationsClient.NewListPager", &tracing.SpanOptions{
...
func (client *AvailableDelegationsClient) listHandleResponse(resp *http.Response) (result AvailableDelegationsClientListResponse, err error) {
